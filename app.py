...
def agregar_mensajes_log(texto):
    ...
    nuevo_registro = Log(
        ...
        fecha_y_hora=datetime.now(
            timezone.utc
        ),  # Agregamos explícitamente la fecha y hora
    )
...
def enviar_mensajes_whatsapp(texto, number):
    ...
    if "hola" in texto:
        ...
        data = {
            ...
            "location": {
                "latitude": "-34.545249",
                "longitude": "-58.452338",
                "name": "Estadio El Más Monumental",
                "address": "Av. Pres. Figueroa Alcorta 7597, C1428 Cdad. Autónoma de Buenos Aires",
            },
        }
    elif "3" in texto:
        data = {
            ...
            "type": "document",
            "document": {
                "link": "https://www.cariverplate.com.ar/imagenes/Version_Digital_River_volvio_a_ser_River3.pdf",
                "caption": "Version Digital River volvio a ser River",
            },
        }
    elif "4" in texto:
        data = {
    ...
    try:
        ...
        connection.request("POST", "/v21.0/102157665850860/messages", data, headers)
